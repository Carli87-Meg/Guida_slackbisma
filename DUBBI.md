...
| 3 | intro | Coordinate dei due ancoraggi | Intestazione dei blocchi materiale (cliccabili) | mai pronunciate | **mezzo chiuso** — l'**ancoraggio main** e' a `44.419869, 10.412353`, quota 1025 m: EXIF di `IMG_1416`, scattata stando li' il 16/05/2026 alle 17:14 (utente, 20/08/2026). E' la posizione del telefono, non un rilievo. **L'ancoraggio opposto resta aperto.** i-pietra non aiuta: i suoi `linePoints` sono coordinate della scena 3D, non GPS |
...
| 50 | E | **C'è un A-frame** — due pali di legno con fettucce — mai nominato in nessuna trascrizione | Elemento strutturale del lato tensione: altezza, materiale e ancoraggio a terra sono tutti ignoti | `IMG_1396`, `IMG_1416` | **parziale** — con `IMG_1416` (utente, 20/08/2026) l'A-frame ha una sezione nel manuale. Si vede che sta **sul lato dell'ancoraggio main**, che i piedi **appoggiano sulla roccia** e che attorno al piede di un palo ci sono **giri di filo metallico** che proseguono orizzontali. Restano aperti: altezza, diametro del legno, legatura in testa, di quanto solleva la linea, e **se quel filo tenga il palo o sia un recinto preesistente** |
...
| 54 | — | **Nello sfondo di `IMG_1416` e `IMG_1396` corre una linea tesa con, sotto, una seconda linea chiara appesa a festoni.** Non si capisce se sia la campata della 53 m vista di scorcio o un'altra linea dello spot | Se fosse un'altra linea, due fotografie del capitolo della 53 m ne mostrerebbero una diversa senza dirlo | `IMG_1416`, `IMG_1396` | aperto — **da chiedere a chi c'era** |
| 55 | E | **Che cos'è la seconda linea appesa a festoni** sotto quella tesa: backup, tagline lasciata in posa, o altro | Chiude in parte i dubbi 23 e 24 | `IMG_1416`, `IMG_1396` | aperto |
